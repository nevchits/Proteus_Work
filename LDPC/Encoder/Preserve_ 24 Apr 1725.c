...
HighNibble >>=2;
preserved = HighNibble.B2;
HighNibble<<=1;
highNibble.B2 = preserved;

p1 = HighNibble.B2 ^ highNibble.B4;
p1 = p1 ^ highNibble.B6;
HighNibble.B0 = p1;

p2 = HighNibble.B2 ^ HighNibble.B5;
p2 = p2 ^ HighNibble.B6;
HighNibble.B1 = p2;

p4 = HighNibble.B4 ^ HighNibble.B5;
p4 = p4 ^ HighNibble.B6;
HighNibble.B3 = p4;
...
LowNibble >>=2;
preserved = LowNibble.B2;
LowNibble<<=1;
LowNibble.B2 = preserved;

p1 = LowNibble.B2 ^ LowNibble.B4;
p1 = p1 ^ LowNibble.B6;
LowNibble.B0 = p1;

p2 = LowNibble.B2 ^ LowNibble.B5;
p2 = p2 ^ LowNibble.B6;
LowNibble.B1 = p2;

p4 = LowNibble.B4 ^ LowNibble.B5;
p4 = p4 ^ LowNibble.B6;
LowNibble.B3 = p4;
